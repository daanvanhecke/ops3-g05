...
$ADServer = 'PFSV1' #change name to your DC
...
$searchbase = "OU=PFAfdelingen,DC=Poliforma,DC=nl" #Amend this to the actual OU. 
...
New-Item -ItemType Directory -Path "F$\UserFolders\$($ADUser.sAMAccountname)"
#New-Item -ItemType Directory -Path "\\PFSV1\UserFolders\$($ADUser.DisplayName)"
...
$userfolder = "F$\UserFolders\$($ADUser.sAMAccountname)"
#$userfolder = "F$\UserFolders\$($ADUser.DisplayName)"
...
$homeDirectory = "F$\UsersFolders\$($ADUser.sAMAccountname)" #This maps the folder for each user 
#$homeDirectory = "F$UserFolders\$($ADUser.DisplayName)" #This maps the folder for each user 

#Set homeDrive for each user

$homeDrive = "F" #This maps the homedirectory to drive letter H 
